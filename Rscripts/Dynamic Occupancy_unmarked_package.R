...
detection_history <- read.csv("Dynamic_Occupancy_Intro/dynamic_detection_history.csv", 
                              # First variable ("X") has row.names but not data
                              row.names = "X") 
